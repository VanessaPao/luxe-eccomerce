      ...
      schemas: {
        ...
        Review: {
          ...
          properties: {
            ...
            userId: { type: "string", description: "UID del usuario que escribió la reseña" },
            userName: { type: "string", description: "Nombre del usuario" },
            rating: { type: "integer", description: "Calificación del 1 al 5", minimum: 1, maximum: 5 },
            text: { type: "string", description: "Texto de la reseña" },
